...
<button className='w-32 h-4 p-4  bg-green-500 text-white flex rounded-3xl     justify-center items-center' onClick={()=>{setToggle(!toggle)}}>Dark Mode</button>
      <div className="bg-white p-8 rounded-2xl mx-auto shadow-lg w-full max-w-md">

      <p>{!hide && 'enter your correct email and password'}</p>
      <button className='text-black ' onClick={()=>{setHide(!hide)}}>  { hide ? "show" : "Hide"} Text</button>
