        ...
        <div className="p-6 border-t border-gray-200">
          <div className="text-center mb-4">
            <p className="text-2xl font-bold text-gray-800">{count}</p>
              ...
              <div>
                <h3 className={`font-bold  ${toggle? 'text-green-300':'text-red-400'}`}>{toggle? `liked` : `not liked`}</h3>
                <button className='text-white bg-green-500 p-2 m-2 rounded-md' onClick={()=>{setToggle(!toggle)}}>{toggle? 'DIslike':"like"}</button>
